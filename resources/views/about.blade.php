  ...
  <section id="contact-us" class="container py-5">
    ...
    <div class="col-md-7">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control fs-5" id="name" placeholder="Your Name" ">
      </div>
      <div class=" mb-3">
        <label for="email" class="form-label">Email</label>
        <input type="email" class="form-control fs-5" id="email" placeholder="Your Email" ">
      </div>
      <div class=" mb-3">
        <label for="message" class="form-label">Message</label>
        <textarea class="form-control fs-5" id="message" rows="6" placeholder="Your Message"></textarea>
      </div>
