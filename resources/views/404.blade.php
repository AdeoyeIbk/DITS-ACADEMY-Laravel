...
@section('content')
  ...
  <head>
    ...
    {{ request()->is('login') ? "Login -" : "" }} {{ request()->is('student-profile') ? "Profile -" : "" }}
  ...
  <body>
    ...
    <div class="content">
    <h1>404</h1>
    <p class="error-message">This is the error that you are facing and it is like there are a couple of things that you
      could do about it. Try that and let's see if it will work. Cheers!</p>
    <div class="action-button-container">
      <button class="btn btn-primary">Go Back</button><button class="btn btn-primary">Return to Home</button>
    </div>
    </div>
  @endsection