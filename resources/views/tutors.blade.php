...
@section('content')
  ...
  <section id="tutors-section">
    ...
    <div class="tutor-card">
    <img src="../images/tutors-images/microsoft office essentials tutor.jpg" alt="Microsoft Office Essentials Tutor">
    <div class="card-body">
    ...
    <div class="tutor-card">
    <img src="../images/tutors-images/AI tutor.avif" alt="AI in business tutor">
    <div class="card-body">
    ...
    <div class="tutor-card">
    <img src="../images/tutors-images/social media management tutor.avif" alt="social media management tutor">
    <div class="card-body">
    ...
    <div class="tutor-card">
    <img src="../images/tutors-images/mobile app development tutor.avif" alt="mobile app development tutor">
    <div class="card-body">
    ...
    <div class="tutor-card">
    <img src="../images/tutors-images/data analysis tutor.avif" alt="data analysis tutor">
    <div class="card-body">
    ...
    <div class="tutor-card">
    <img src="../images/tutors-images/forex tutor.avif" alt="mobile app development tutor">
    <div class="card-body">
    ...
    <div class="tutor-card">
    <img src="../images/tutors-images/web development tutor.avif" alt="web development tutor">
    <div class="card-body">
    ...
    <div class="tutor-card">
    <img src="../images/tutors-images/graphics design tutor.png" alt="graphics design tutor">
    <div class="card-body">
    ...
    <div class="tutor-card">
    <img src="../images/tutors-images/digital marketing tutor.jpg" alt="digital marketing tutor">
    <div class="card-body">
  ...
  <section class="join-tutors-section py-5 text-center bg-primary">
    ...
    <a href="become-a-tutor.html" class="btn btn-light btn-lg">Join Our Team</a>
    </div>
  </section>
@endsection